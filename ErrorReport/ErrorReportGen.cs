...
{
    class ErrorReportGen
    {
        private const string START_JS = "/**START MY JAVASCRIPT**/";

        public ErrorReportGen(string output, List<JobHistory> jobHistory, int numOfTrunk = 10)
        {
            ReportInfo info = new ReportInfo(jobHistory, numOfTrunk);
