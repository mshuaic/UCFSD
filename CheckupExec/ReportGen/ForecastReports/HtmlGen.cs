...
namespace CheckupExec.Utilities
{
    public class HtmlGen
    {
        ...
        public void makeReportDisk(List<DiskCapacityReport> reps, string loc)
        {
            ...
            string finalHtml = newHtml.Insert(newHtml.IndexOf("<!--CHARTS AREA-->") + "<!--CHARTS AREA-->".Length, sc.chartDisk(reps));
            System.IO.File.WriteAllText(loc + @"\diskReport.html", finalHtml);
