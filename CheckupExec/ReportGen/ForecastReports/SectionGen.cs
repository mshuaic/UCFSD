        ...
        public string middleDisk(List<DiskCapacityReport> reps)
        {
            ...
            using (HtmlTextWriter writer = new HtmlTextWriter(stringWriter))
            {
                ...
                foreach (DiskCapacityReport rep in reps)
                {
                    ...
                    {
                        writer.RenderBeginTag(HtmlTextWriterTag.P);
                        writer.Write("50% Capacity reached: " + Math.Abs(rep.DaysTo50) + " Days ago");
                        writer.RenderEndTag();
                    ...
                    {
                        writer.RenderBeginTag(HtmlTextWriterTag.P);
                        writer.Write("75% Capacity reached: " + Math.Abs(rep.DaysTo75) + " Days ago");
                        writer.RenderEndTag();
                    ...
                    {
                        writer.RenderBeginTag(HtmlTextWriterTag.P);
                        writer.Write("90% Capacity reached: " + Math.Abs(rep.DaysTo90) + " Days ago");
                        writer.RenderEndTag();
            ...
            using (HtmlTextWriter writer = new HtmlTextWriter(stringWriter))
            {
                foreach (FrontEndCapacityReport rep in reps)
                {
                    ...
                    foreach (BackupJobReport bacRep in rep.BackupJobs)
                    {
                        ...
                        writer.RenderEndTag();
                        writer.RenderBeginTag(HtmlTextWriterTag.P);
                        writer.Write("Estimated restore time of next job: " + (bacRep.NextElapsedTimeSeconds/60) + " minutes");
                        writer.RenderEndTag();
        ...
        public string middleJob(List<BackupJobReport> reps) {
            ...
            using (HtmlTextWriter writer = new HtmlTextWriter(stringWriter))
            {
                ...
                foreach (BackupJobReport rep in reps)
                {
                    ...
                    {
                        writer.RenderBeginTag(HtmlTextWriterTag.P);
                        writer.Write("100% Capacity reached: " + Math.Abs(rep.DaysToFull) + " Days ago");
                        writer.RenderEndTag();
                    ...
                    writer.RenderBeginTag(HtmlTextWriterTag.P);
                    writer.Write("Estimated restore time of next job: " + (rep.NextElapsedTimeSeconds / 60) + " minutes");
                    writer.RenderEndTag();
                    writer.RenderEndTag();
